...
python buildPreviews.py $Integra_grotesque $Integra_script otf "$words" $Integra_out
python buildPreviews.py $Gabion_display $Gabion_text otf "$words" $Gabion_out
python buildPreviews.py $Afrikola_headline $Afrikola_monospace otf "$words" $Afrikola_out
